...
public class RenderTypes extends RenderType {
    ...
    public static final RenderType PHANTOM = create(
            "phantom",
    ...
    public static final RenderType NOPE = create(
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setLightmapState(LIGHTMAP)
                    .setTextureState(BLOCK_SHEET_MIPPED)
                    .setDepthTestState(NO_DEPTH_TEST)   // 不要让错误标记被遮挡
                    .createCompositeState(true)
    );
    ...
    public static final RenderType THICK_LINES = create(
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setLineState(new RenderStateShard.LineStateShard(OptionalDouble.of(10.0D)))
